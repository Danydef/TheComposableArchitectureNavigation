...
extension Item {
    ...
    static let keyboard = Self(
        name: "Keyboard",
        color: .yellow,
        status: .outOfStock(isOnBackOrder: false)
    )
    static let monitor = Self(
        name: "Monitor",
        color: .red,
